...
export default function CesiumViewport() {
  ...
  //WARNING! The first click on refresh or just moving the globe is (0,0) coords - wrong
  ...
  return (
    <div className="text-center">
      <header className="bg-[#282c34] min-w-[100svh] grid">
        <div className="w-4/5 h-full" ref={divRef} onDoubleClick = {getPositionOnClick}/>
